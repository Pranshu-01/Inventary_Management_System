...
const Edit = () => {
    ...
    const handleDate=(e)=>{
        setData({...data,date:{...data.date,received_date:e.target.value}})
    }

	const handleQuantity=(e)=>{
        setData({...data,quantity:{...data.quantity,received_quantity:e.target.value}})
    }
			...
			<Container>
				<Wrapper>
					...
					<Form onSubmit={handleSubmit}>
						<Text>Name</Text>
						<Select name='name' onChange={handleName} value={data.name} required>
